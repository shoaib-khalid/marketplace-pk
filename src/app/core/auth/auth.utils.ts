...
// @ AUTH UTILITIES
//
// Custom Methods for Kalsym User Service
// https://api.symplified.it/user-service/v1/swagger-ui/index.html?configUrl=/user-service/v1/v3/api-docs/swagger-config#/
// -----------------------------------------------------------------------------------------------------
